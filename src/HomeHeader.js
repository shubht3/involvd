  ...
  return (
    <div class="homeHeader">
      <div class="homeHeaderLogoAndSearch">
        <Link to="/">
          <img src="https://i.ibb.co/fSJhqM4/Screen-Shot-2020-11-22-at-6-42-40-AM-removebg-preview.png" class="homeHeader__logo" />
        </Link>
        ...
        <input type="text" className="searchBox" placeholder="Search Involvd" onChange={updateSearchResults} />
